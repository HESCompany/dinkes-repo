...
class Config:
    ...
    SQLALCHEMY_DATABASE_URI = os.environ.get('MYSQL_URL') or         f"mysql+pymysql://{os.environ.get('MYSQLUSER')}:{os.environ.get('MYSQLPASSWORD')}@"         f"{os.environ.get('MYSQLHOST')}:{os.environ.get('MYSQLPORT')}/{os.environ.get('MYSQLDATABASE')}"
